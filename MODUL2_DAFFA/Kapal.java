...
public class Kapal extends TransportasiAir {
    ...
    void berlayar() {
        System.out.println("Transportasi Air jenis Kapan sedang berlayar menggunakan mesin "+this.mesin+" dengan kecepatan yang tidak stabil");
    }

    void berlayar(int kecepatan) {
        System.out.println("Transportasi Air jenis Kapan sedang berlayar menggunakan mesin "+this.mesin+" dengan kecepatan yang stabil di kisaran "+kecepatan+" knot");
    }
